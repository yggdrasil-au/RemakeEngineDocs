...
This section is aimed at contributors extending the engine or building new modules. It covers the module-first philosophy, directory layout, manifest authoring, script guidance, tooling, and contribution workflow.

- [Overview](overview.md)
- [Adding a New Module](adding_new_game.md)
